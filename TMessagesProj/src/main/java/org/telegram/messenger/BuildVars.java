...
public class BuildVars {
    ...
    // Set these to an API id and hash registered for the independent client.
    // Official Telegram credentials must not be reused by forks.
    public static int APP_ID = BuildConfig.ORBIT_API_ID;
    public static String APP_HASH = BuildConfig.ORBIT_API_HASH;
